...
class CommentPage extends StatelessWidget {
  const CommentPage({super.key, required this.topics});
  final Topics topics;
          ...
          Consumer<CComment>(
            builder: (contextConsumer, _, child) {
              if (_.comments.isEmpty) {
                return DView.empty('this topics not have comment yet');
              }
              return ListView.builder(
                itemCount: _.comments.length,
                itemBuilder: (context, index) {
                  Comments comment = _.comments[index];
                  return Container(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  if (comment.toUser.id != topics.idUser)
                                    const Text(
                                      ' to ',
                                      style: TextStyle(
                                        color: Colors.grey,
                                  ...
                                  const Spacer(),
                                  Text(
                                    AppFormat.publishDate(comment.createdAt),
