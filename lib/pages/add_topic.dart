...
class AddTopic extends StatelessWidget {
  ...
  addNewTopic(BuildContext context) {
    TopicSource.create(
        ...
        .then((success) {
      if (success) {
        DInfo.snackBarSuccess(context, "Topic Created Successfully");
          ...
          Padding(
            ...
            child: Row(
              children: [
                ElevatedButton.icon(
                  onPressed: () {
                    context.read<CAddTopic>().pickImages(ImageSource.gallery);
                  },
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    context.read<CAddTopic>().pickImages(ImageSource.camera);
                  },
